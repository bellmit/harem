 ...
 */
@Controller
@RequestMapping("/jiuxiu/ugcManage")
public class UgcManageController extends BaseController {
    @Autowired
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/ugclist", method = RequestMethod.GET)
    ...
    public String recommendList(Model model, LiveListQuery liveListQuery) throws Exception {
    	PageVO<SnsSubjectVO> pageVO = liveService.getList(liveListQuery);
    	model.addAttribute("pageVo", pageVO);
    	model.addAttribute("liveListQuery", liveListQuery);
    	model.addAttribute("liveList", pageVO.getItemList());
    	return "/system/live/recommendList";
    }
