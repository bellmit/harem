...
//		verifyCmpEleAccountDTO.setCorpBusiCode(dto.getSaleLicenseNumber());
		...
		examineInfoDTO.setSellerId(3332);
		examineInfoDTO.setAccountType("2");
		examineInfoDTO.setSettlementCard("102100099996");
		examineInfoDTO.setAccountBankName("111111111");
		...
		examineInfoDTO.setPrincipleName("1111");
		examineInfoDTO.setPrincipleTel("11222222222");
