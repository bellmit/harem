...
//这个就是自己要保管好的私有Key了（切记只能放在自己的后台代码里，不能放在任何可能被看到源代码的客户端程序中）
	...
	private final static String key = "gje76b0llwaghcavywd0mhsqowiext4e";

	//微信分配的公众号ID（开通公众号之后可以获取到）
	private final static String appID = "wxbf88b9101334334e";

	//微信支付分配的商户号ID（开通公众号的微信支付功能之后可以获取到）
	private final static String mchID = "1235808102";
	...
	//机器IP
	private final static String ip = "119.254.102.238";
	...
	//通知地址
	public final static String NOTIFY_URL_ORDER = "http://119.254.102.238:18080/orderPay/orderPayNotice";

	//通知地址
	public final static String NOTIFY_URL_ORDER_INVEST = "http://119.254.102.238:18080/orderInvestPay/orderInvestPayNotice";
	...
	public static void setSubMchID(String subMchID) {
		WeChatConfigure.subMchID = subMchID;
	}

	public static void setCertLocalPath(String certLocalPath) {
		WeChatConfigure.certLocalPath = certLocalPath;
	}

	public static void setCertPassword(String certPassword) {
		WeChatConfigure.certPassword = certPassword;
	}
