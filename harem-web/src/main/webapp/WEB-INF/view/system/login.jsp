...
<body>
<div class="container">
	<form class="form-signin" id="loginForm" action="/login" method="post" role="form">
		<div class="form-group">
			...
			<button class="btn btn-lg btn-primary btn-block" type="submit" onclick="return subForm(this);">登录</button>
		</div>
	</form>
</div>
</body>
